<script lang="ts">
    ...
    import { myInfoStore } from "../stores/nfts.store";
    import { collection } from "../stores/forms.store";
    ...
    <div class="row row--grid">
        ...
        <div class="col-12 col-xl-9">
            ...
            <div class="main__title main__title--create">
                <h2>Create Dynamic Collection</h2>
            </div>
            <!-- end title -->
                ...
                <div class="row" style="width: 100%;">
                    <div class="col-12">
                        <div class="sign__group">
                            <label class="sign__label" for="contract">Address</label>
                            <input bind:value={$collection.contract} id="contract" type="text" name="contract"
                                   class="sign__input"
                                   placeholder="0x777...">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="sign__group">
                            ...
                            <input bind:value={$collection.title} id="itemname" type="text" name="itemname"
                                   class="sign__input"
                                   placeholder="e. g. Football League">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="sign__group">
                            ...
                            <textarea bind:value={$collection.description} id="description" name="description"
